...
export default class EspersEquipmentSheet extends EspersItemSheet {
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['espers', 'sheet', 'item', 'equipment']
    };
    ...
    static TABS = {
        sheet: [
            { id: 'description', group: 'equipment', label: 'ESPERS.Item.tabs.description' },
            { id: 'settings', group: 'equipment', label: 'ESPERS.Item.tabs.settings' },
            { id: 'effects', group: 'equipment', label: 'ESPERS.Item.tabs.effects' }
        ]
    };
