...
export default class EspersWeaponSheet extends EspersItemSheet {
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['espers', 'sheet', 'item', 'weapon']
    };
    ...
    static TABS = {
        sheet: [
            { id: 'description', group: 'weapon', label: 'ESPERS.Item.tabs.description' },
            { id: 'settings', group: 'weapon', label: 'ESPERS.Item.tabs.settings' },
            { id: 'effects', group: 'weapon', label: 'ESPERS.Item.tabs.effects' }
        ]
    };
