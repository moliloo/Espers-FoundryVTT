...
export default class EspersGemsSheet extends EspersItemSheet {
    static DEFAULT_OPTIONS = {
        tag: 'form',
        classes: ['espers', 'sheet', 'item', 'gems']
    };

    static PARTS = {
        header: {
            id: 'header',
            template: 'systems/espers/templates/sheets/items/gems/header.hbs'
        },
        tabs: {
            id: 'tabs',
        ...
        settings: {
            template: 'systems/espers/templates/sheets/items/gems/settings.hbs',
            scrollable: ['.settings']
        },
        effects: {
    ...
    static TABS = {
        sheet: [
            { id: 'description', group: 'gems', label: 'ESPERS.Item.tabs.description' },
            { id: 'settings', group: 'gems', label: 'ESPERS.Item.tabs.settings' },
            { id: 'effects', group: 'gems', label: 'ESPERS.Item.tabs.effects' }
        ]
    };
